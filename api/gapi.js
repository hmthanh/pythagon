/* JS */ gapi.loaded_0(function(_) {
        ...
        if (n && Ta(k.nf, m))
          for (k = 0; k < n.length; k++) {
            ...
            if ((l !== l && p.key !== p.key) || l === p.key)
              return { id: m, list: n, index: k, ne: p };
          }
        return { id: m, list: n, index: -1, ne: void 0 };
      },
      e = function(k, l) {
        var m = k.Te;
        return Pa(function() {
  ...
  Ka("Promise", function(a) {
    ...
    e.prototype.$y = function() {
      ...
      var k = this,
        l = !1;
      return { resolve: g(this.OZ), reject: g(this.hj) };
    };
  ...
  _.wb = Array.prototype.filter
    ...
    : function(a, b) {
        for (
          var c = a.length, d = [], e = 0, f = _.Ya(a) ? a.split("") : a, g = 0;
          g < c;
          g++
        )
          if (g in f) {
  ...
  _.xb = Array.prototype.map
    ...
    : function(a, b) {
        for (
          var c = a.length, d = Array(c), e = _.Ya(a) ? a.split("") : a, f = 0;
          f < c;
          f++
        )
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
  ...
  lf = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*[\0-\x1f]/;
  mf = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\[^\\\/"bfnrtu]/;
  nf = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\u([0-9a-fA-F]{0,3}[^0-9a-fA-F])/;
  of = /"([^\0-\x1f\\"]|\\[\\\/"bfnrt]|\\u[0-9a-fA-F]{4})*"/g;
  ...
  _.Ui = function(a, b, c) {
    a = Ri(a);
    Gi[a.name] = { Pg: b, fr: a.fr, Ko: c || Pi };
    Si();
  };
  _.Vi = function(a) {
    delete Gi[Ri(a).name];
  ...
  fj = function(a, b, c) {
    Ei.push({ rpc: a, origin: b, timestamp: new Date().getTime() / 1e3 });
    c || Si();
  };
  ui = function(a, b) {
    a = _.Ff(a);
  ...
  dk = function(a, b) {
    if (0 == a.Ba)
      if (a.Ya) {
        ...
        if (c.Pj) {
          for (
            var d = 0, e = null, f = null, g = c.Pj;
            g && (g.lp || (d++, g.Yk == a && (e = g), !(e && 1 < d)));
            g = g.next
          )
            e || (f = g);
          e &&
  ...
  _.Qj.prototype.QS = function() {
    for (var a; (a = ek(this)); ) fk(this, a, this.Ba, this.Ff);
    this.Nz = !1;
  };
  var fk = function(a, b, c, d) {
      if (3 == c && b.Tn && !b.lp) for (; a && a.Fu; a = a.Ya) a.Fu = !1;
  ...
  _.Jh.prototype.update = function(a, b) {
    if (null != a) {
      ...
      for (var c = b - this.Nj, d = 0, e = this.Cy, f = this.Dn; d < b; ) {
        if (0 == f) for (; d <= c; ) Kh(this, a, d), (d += this.Nj);
        if (_.Ya(a))
          for (; d < b; ) {
  ...
  al = { allowtransparency: !0, onload: !0 };
  bl = 0;
  _.cl = function(a, b) {
    var c = 0;
  ...
  _.Zl = function(a, b, c) {
    _.Bk("_default" != a, "Cannot update default api");
    _.qe(Fl, a, { map: {}, filter: _.Tl }).map[b] = c;
  };
  _.$l = function(a, b) {
    _.qe(Fl, "_default", { map: {}, filter: _.Ul }).map[a] = b;
  ...
  _.h.dS = function(a) {
    ...
    Dm(b);
    d = d || "";
    _.qe(b.Ry, d, []).push({ Af: c.yd(), data: a });
    Em(c, a, b.kC[d]);
  };
  _.h.RD = function(a, b) {
  ...
  _.Ap = function(a, b, c, d, e) {
    ...
    if (e) for (g in _.R.vn) _.R.vn.hasOwnProperty(g) && f.push(g);
    return f.join(",");
  };
  Cp = function(a, b, c) {
    var d = {};
  ...
  var up = /^[-_.0-9A-Za-z]+$/,
    ...
    Tp = { onBeforeParentOpen: "beforeparentopen" },
    Up = {
      onOpen: function(a) {
        var b = a.Ob();
  ...
  Uo = function(a) {
    if ((a = a.eZ)) for (var b = 0; b < a.length; b++) new Image().src = a[b];
  };
  Vo = function(a, b) {
    var c = b.userParams,
      d = b.siteElement;
  ...
  bp = function(a, b) {
    if ("string" == typeof a) {
      a = a.toLowerCase();
      var c;
      for (c = 0; c < b.length; c++) if (b[c] == a) return a;
    }
  };
  _.cp = function(a) {
    return bp(a, ap);
  ...
  var xZ = {
      tall: {
        true: { width: 50, height: 60 },
        false: { width: 50, height: 24 }
      },
      small: {
        false: { width: 24, height: 15 },
        true: { width: 70, height: 15 }
      },
      medium: {
        false: { width: 32, height: 20 },
        true: { width: 90, height: 20 }
      },
      standard: {
        false: { width: 38, height: 24 },
        true: { width: 106, height: 24 }
      }
    },
    yZ = { width: 180, height: 35 },
    zZ = function(a) {
      return "string" == typeof a
      ...
      if ("" != a) {
        if ("inline" == a || "only" == a)
          return (
            ...
            { width: a, height: xZ[b]["false"].height }
          );
        if ("bubble" != a) {
